    ...
    <div className='m-5 p-5 shadow ' id="features" >
        ...
        <div className='row p-5 feature-main'>
            <div className='col-md-6 p-5 ' height="400px" >
                ...
                <p className='my-5 bg-success bg-opacity-10 p-5'>
        ...
        <div>
            <div className='row p-5 feature-main'>
                <div className='col-md-6  p-5' height="400px">
                    ...
                    <p className='my-5 bg-success bg-opacity-10 p-5'>You can view your debts for a certain destination in a certain group to a certain member anytime according to your convenience</p>
                </div>
                <div className='col-md-6'>
        ...
        <div>
            <div className='row p-5 feature-white'>
                ...
                <div className='col-md-6  p-5' height="400px">
                    ...
                    <p className='my-5 bg-success bg-opacity-10 p-5'>Finally, after clearing your debts FairSplit clears your record and you are sorted!</p>
                </div>
            </div>
        </div>
    </div>
